...
inline SDL_Surface* take_screenshot(size_t timeout_ms = 2000) {
    ...
    auto capture = SL::Screen_Capture::CreateCaptureConfiguration([&monitors] { return monitors; })
    ...
    if (framesReceived == 0) return nullptr;
